...
export default function Contact() {
  ...
  return (
    <>
      <SEOHead title="Contact Us" description="Get in touch with Zac Studio. We respond within 24 hours. Start your project today." path="/contact" />
            ...
            <div className="container" style={{ position:'relative', zIndex:1 }}>
              <div className="row g-5 align-items-start">
                ...
                <div className="col-12 col-md-5">
                  ...
                  {[['EMAIL','hello@zacstudio.com'],['RESPONSE TIME','Within 24 hours']].map(([label,val]) => (
                  ...
                  <div className="d-flex flex-wrap gap-3">
                    {['Twitter','LinkedIn','Dribbble','GitHub'].map(s => (
                      <a key={s} href="#" style={{ color:'var(--text-muted)', fontFamily:'var(--font-display)', fontSize:'0.58rem', letterSpacing:'2px', textDecoration:'none', transition:'color 0.25s' }}
                    ...
                    <div className="zac-card" style={{ padding:'2.5rem' }}>
                      <form onSubmit={submit}>
                        <div className="row g-4">
                          ...
                          <div className="col-12">
                            <button type="submit" className="btn-zac-filled">Send Message →</button>
                          </div>
                        </div>
                      </form>
                    </div>
