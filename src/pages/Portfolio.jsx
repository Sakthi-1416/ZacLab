...
const projects = [
  { id:1, title:'Nomad Eats',    cat:'Web',    tags:['React','Node.js','UX'],    color:'#1a0608', year:'2024', desc:'Full-stack food delivery platform. Custom order tracking, dynamic restaurant onboarding, mobile-first.' },
  { id:2, title:'Folio Studio',  cat:'Design', tags:['UI/UX','Figma'],           color:'#060e1a', year:'2024', desc:'Portfolio builder for creatives. Drag-and-drop editor, template engine, CMS integration.' },
  { id:3, title:'GreenPath SEO', cat:'SEO',    tags:['SEO','Analytics'],         color:'#060a0f', year:'2023', desc:'11-month SEO campaign for a sustainable goods brand. Grew organic traffic 420%.' },
  { id:4, title:'Pulseboard',    cat:'Data',   tags:['Python','SQL','Looker'],   color:'#0f0a06', year:'2023', desc:'Real-time analytics dashboard for a SaaS startup. Custom KPIs, automated reporting pipeline.' },
  { id:5, title:'Vero Apparel',  cat:'SMM',    tags:['Instagram','Content'],     color:'#0e0606', year:'2023', desc:'Social media strategy and execution. Grew from 2k to 28k followers in 8 months.' },
  { id:6, title:'LexiCare',      cat:'Web',    tags:['Next.js','AWS'],           color:'#06100a', year:'2022', desc:'Healthcare appointment booking system. HIPAA-compliant, multi-tenant, 99.9% uptime.' },
]

const testimonials = [
  { quote:'Zac built our entire platform in 6 weeks. Clean code, clear communication, zero drama.',    name:'Sarah K.',  role:'Founder, Nomad Eats' },
    ...
    <>
      ...
      <div className="page-gradient">
        <div style={{ paddingTop:'100px' }}>
          ...
          <section style={{ padding:'5rem 0 2rem', position:'relative', overflow:'hidden' }}>
            ...
            <div className="container" style={{ position:'relative', zIndex:1 }}>
              ...
              <h1 style={{ fontFamily:'var(--font-script)', fontSize:'clamp(3rem,8vw,5.5rem)', marginBottom:'3rem' }}>
                ...
                {filtered.map((p,i) => (
                  <div key={p.id} className="col-12 col-md-6 col-lg-4">
                    <div className="zac-card h-100">
                      <div style={{
                        width:'100%', height:'175px', marginBottom:'1.5rem',
                        background:`linear-gradient(135deg, ${p.color}, rgba(107,15,26,0.25), #0a0a0a)`,
                        display:'flex', alignItems:'flex-end', padding:'1rem',
                        position:'relative', overflow:'hidden'
                      }}>
                        <div style={{ position:'absolute', inset:0, background:'linear-gradient(135deg, transparent 40%, rgba(192,57,43,0.06) 100%)' }} />
                        <span style={{ fontFamily:'var(--font-script)', fontSize:'2.5rem', color:'rgba(240,236,228,0.08)', position:'relative' }}>{p.title[0]}</span>
                      </div>
              ...
              <div className="row g-4">
                {testimonials.map((t,i) => (
                  <div key={i} className="col-12 col-md-4">
                    <div className="zac-card h-100">
                      <p style={{ color:'var(--crimson-glow)', fontSize:'2.5rem', fontFamily:'Georgia,serif', marginBottom:'1rem', lineHeight:1, textShadow:'0 0 20px rgba(192,57,43,0.4)' }}>"</p>
